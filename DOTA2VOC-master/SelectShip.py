...
if __name__ == '__main__':
    root1 = 'F:\\迅雷下载\\DOTA\\data\\train'
    pic_path = os.path.join(root1+'\\images', 'images')  # 样本图片路径
    label_path = os.path.join(root1, 'labelTxt')  # DOTA标签的所在路径
    label_list = GetFileFromThisRootDir(label_path)
    ship_pic = 'F:\\迅雷下载\\DOTA\\DOTAship\\images'
    ship_label = 'F:\\迅雷下载\\DOTA\\DOTAship\\labelTxt'
