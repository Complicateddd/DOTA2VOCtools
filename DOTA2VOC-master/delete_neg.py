...
if __name__ == '__main__':
    data_path = '/media/ubuntu/新加卷/dataset/DOTA/train/traincrop800/images'
    images_path = os.path.join(data_path)  # 样本图片路径
    labeltxt_path = os.path.join('/media/ubuntu/新加卷/dataset/DOTA/train/traincrop800/labelTxt')  # DOTA标签的所在路径
    anno_new_path = os.path.join('/media/ubuntu/新加卷/dataset/DOTA/train/traincrop800/Annotation')  # 新的voc格式存储位置（hbb形式）
    ext = '.png'  # 样本图片的后缀
