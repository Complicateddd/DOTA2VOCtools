...
if __name__ == '__main__':
    ims_path='/media/ubuntu/新加卷/dataset/DOTA/train/images/'# 图像数据集的路径
   # txt_path = '/home/***/data/VOCdevkit/mydataset/Annotations/txt/'
    # img=cv2.imread('F:\\929.jpg')
    # print(img)
    path = '/media/ubuntu/新加卷/dataset/DOTA/VOCCrop/Train/images' #切割得到的数据集存放路径
